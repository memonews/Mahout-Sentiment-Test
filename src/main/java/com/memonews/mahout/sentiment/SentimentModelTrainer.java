 ...
 * <tr>
 * <td valign='top'>0</td>
 * <td>No leak injected</td>
 * </tr>
 * <tr>
 * <td valign='top'>1</td>
 * <td>Synthetic date injected in MMM-yyyy format. This will be a single token
 * and is a perfect target leak since each newsgroup is given a different month</td>
 * </tr>
 * <tr>
 * <td valign='top'>2</td>
 * <td>Synthetic date injected in dd-MMM-yyyy HH:mm:ss format. The day varies
 * and thus there are more leak symbols that need to be learned. Ultimately this
 * is just as big a leak as case 1.</td>
 * </tr>
 * </table>
 * <p/>
...
public final class SentimentModelTrainer {
	...
	final AdaptiveLogisticRegression learningAlgorithm = new AdaptiveLogisticRegression(2, SentimentModelHelper.FEATURES, new L1());
	...
	ModelSerializer.writeBinary(modelPath, learningAlgorithm.getBest().getPayload().getLearner().getModels().get(0));
